...
//    static let day: TimeInterval = 60 * 60 * 24
    ...
    static let levels: [Difficulty] = [
        ...
        Difficulty(level: "lvl. 8", difficultyLevel: .sage, probability: 0, settings: DifficultySettings(difficultyStamp: "Sage", fakieChance: 0.4, topsideChance: 0.5, negativeChance: 0.07, rewindChance: 0.25, tricksCAP: 19, soulplateForwardInSpinsCAP: 4, soulplateFakieInSpinsCAP: 4, soulplateForwardOutSpinsCAP: 2, soulplateFakieOutSpinsCAP: 1, grooveForwardInSpinsCAP: 3, grooveFakieInSpinsCAP: 3, grooveSidewaysOutSpinsCAP: 5, grooveFSToSoulplateSpinsCAP: 1, grooveBSToSoulplateSpinsCAP: 1, grooveFSToGrooveSpinsCAP: 1, grooveBSToGrooveSpinsCAP: 1), isCustom: false),
