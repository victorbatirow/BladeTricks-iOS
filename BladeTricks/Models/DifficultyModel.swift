...
extension Difficulty {
    ...
    static let levels: [Difficulty] = [
        Difficulty(level: "Own", difficultyLevel: .customSettings, settings: DifficultySettings(difficultyStamp: "Custom Settings", fakieChance: 0.1, topsideChance: 0, negativeChance: 0, rewindOutChance: 0, switchUpRewindAllowed: false, tricksCAP: 6, soulplateForwardInSpinsCAP: 2, soulplateFakieInSpinsCAP: 1, soulplateForwardOutSpinsCAP: 2, soulplateFakieOutSpinsCAP: 1, grooveForwardInSpinsCAP: 1, grooveFakieInSpinsCAP: 1, grooveFSToSoulplateSpinsCAP: 1, grooveBSToSoulplateSpinsCAP: 1, grooveFSToGrooveSpinsCAP: 1, grooveBSToGrooveSpinsCAP: 1, fsOutSpinsCAP: 1, bsOutSpinsCAP: 1), isCustom: true),
        ...
        Difficulty(level: "lvl. 3", difficultyLevel: .appretice, settings: DifficultySettings(difficultyStamp: "Appretice", fakieChance: 0.2, topsideChance: 0, negativeChance: 0, rewindOutChance: 0, switchUpRewindAllowed: false, tricksCAP: 10, soulplateForwardInSpinsCAP: 2, soulplateFakieInSpinsCAP: 2, soulplateForwardOutSpinsCAP: 2, soulplateFakieOutSpinsCAP: 2, grooveForwardInSpinsCAP:2, grooveFakieInSpinsCAP: 1, grooveFSToSoulplateSpinsCAP: 2, grooveBSToSoulplateSpinsCAP: 1, grooveFSToGrooveSpinsCAP: 1, grooveBSToGrooveSpinsCAP: 1, fsOutSpinsCAP: 2, bsOutSpinsCAP: 2), isCustom: false),
